...
export const ERROR_CODES = {
  ...
  // v3.3 — scale (variable-measure) barcode scanning.
  SCALE_ITEM_NOT_FOUND: 'SCALE_ITEM_NOT_FOUND',
  SCALE_PRICE_UNRESOLVABLE: 'SCALE_PRICE_UNRESOLVABLE',
  ...
  ORGANIZATION_HAS_DATA: 'ORGANIZATION_HAS_DATA',
